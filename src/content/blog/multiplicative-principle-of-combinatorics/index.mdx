...
> Definition:
> if there are $x$ ways of doing one thing and $b$ ways of doing another 

An example is:

Question: You have to travel to the airport. There are a few different ways that will get you there on time.
