...
published: false
slug: callbacks-spatial-temporal
tags:
  - promises
  - callbacks
  - javascript
...
is already there when the function is called (that would make it vacuosly spatial, but I couldn't think of a more fitting example off the top of my head haha).
...
document.body.appendChild(
  el(
    "div",
    { id: "foo", style: { height: "33vh", ...centerStyles } },
    text("Hover me"),
  ),
);
document.body.appendChild(
  el(
    "div",
    { id: "bar", style: { height: "33vh", ...centerStyles } },
    text("Hover me"),
  ),
);
document.body.appendChild(
  el(
    "div",
    { id: "baz", style: { height: "33vh", ...centerStyles } },
    text("Hover me"),
  ),
);
...
on(
  ...
  (e) => {
    ...
    const lightness = lerp(
      0,
      100,
      (Date.now() % pulseTimeMS) / pulseTimeMS,
    ).toFixed(2);
